      ...
      <Card className="border-none shadow-2xl overflow-hidden bg-zinc-900 border-t-8 border-t-primary">
        <CardHeader className="space-y-2 p-8 text-center bg-zinc-800/50">
          ...
          <CardDescription className="text-zinc-400">
            Internal tool for manual ticket registration. Reference: <span className="text-primary font-mono">{combinedRef}</span>
          </CardDescription>
        </CardHeader>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Reference" className="h-12 bg-zinc-800 border-zinc-700" {...field} readOnly />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
